 ...
 *
 * 1.solution:combineLatest
 *
 * the Observable trigger each other which means when slower event appears,
 *
 * it will find the lasted faster event.
 *
 * and when faster appears.it  also find the lasted slower event
 *
 *
 * 2.problem: but what if you just want A Observable trigger B Observable and get the lastest event
 * but not vice versa.
 *
 * 2.solutioin: withLatestFrom()   Rx 1.0.1 --> 1.2.3
 */
